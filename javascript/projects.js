...
img7.onmouseover = img7.onmouseout = changeImage7;
// img8.onmouseover = img8.onmouseout = changeImage8;
...
function changeImage7(e) {
  if (event.type == 'mouseover') {
    document.getElementById('img7').src = './img/color-7.jpg';
  }
  if (event.type == 'mouseout') {
    document.getElementById('img7').src = './img/black-7.jpg';
  }
}

// function changeImage8(e) {
//   if (event.type == 'mouseover') {
//     document.getElementById('img8').src = 'img/color-8.jpg';
//   }
//   if (event.type == 'mouseout') {
//     document.getElementById('img8').src = 'img/black-8.jpg';
//   }
// }
